...
material=MaterialProperties(1,200,0.3,200e9,180e6,210e6,2000)
...
FOS_Bending,FOS_Contact = turntable.calculateStresses()
print(f"Bending factor of safety = {FOS_Bending}\nContact factor of safety = {FOS_Contact}")